...
void __gnat_set_sjlj_context (struct SjLj_Function_Context *);
struct SjLj_Function_Context *__gnat_get_sjlj_context (void);

void
_Unwind_SjLj_Register (struct SjLj_Function_Context *fc)
{
  fc->prev = __gnat_get_sjlj_context ();
  __gnat_set_sjlj_context (fc);
}

static inline struct SjLj_Function_Context *
_Unwind_SjLj_GetContext (void)
{
  return __gnat_get_sjlj_context ();
}
