...
package STM32_SVD.PWR is
   ...
   --  CR2_PVMEN array
   type CR2_PVMEN_Field_Array is array (1 .. 4) of Boolean
   ...
   type CR3_Register is record
      ...
      --  STDBY
      UCPD1_STDBY    : Boolean := False;
      --  DBDIS
      UCPD1_DBDIS    : Boolean := False;
   ...
   --  PUCRG_PU array
   type PUCRG_PU_Field_Array is array (0 .. 10) of Boolean
     with Component_Size => 1, Size => 11;
   ...
   --  PDCRG_PD array
   type PDCRG_PD_Field_Array is array (0 .. 10) of Boolean
     with Component_Size => 1, Size => 11;
